...
- `plugin/skills/{create-wiki,update-wiki,ask,deep-research}/SKILL.md` — orchestration (ours to change; `update-wiki` has no upstream counterpart — the original only offered cache-delete + full regeneration)
